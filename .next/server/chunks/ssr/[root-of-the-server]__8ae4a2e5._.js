...
function Dashboard() {
    ...
    const handleRecordSale = async (productId, quantity)=>{
        try {
            ...
            // Record the sale
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["salesService"].recordSale(productId, quantity, product.price);
    ...
    const handleResetDailySales = async ()=>{
        if (confirm("Are you sure you want to reset today's sales? This cannot be undone.")) {
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["salesService"].resetDailySales();
                await loadProducts();
                await loadTodaySales();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8ae4a2e5._.js.map