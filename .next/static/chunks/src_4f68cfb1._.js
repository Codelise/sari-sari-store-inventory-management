...
"[project]/src/lib/sales.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const salesService = {
    async recordSale (productId, quantity, price) {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["productService"].incrementDailySales(productId, salesAmount);
    },
    async getTodaySales () {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["productService"].getTodayTotalSales();
    },
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/database.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sales$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/sales.ts [app-client] (ecmascript)");
;
...
function Dashboard() {
    ...
    const handleRecordSale = async (productId, quantity)=>{
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sales$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["salesService"].recordSale(productId, quantity, product.price);
            // Reload data
            await loadProducts();
    ...
    // Update your loadTodaySales function:
    const loadTodaySales = async ()=>{
        try {
            setSalesLoading(true);
            // Use salesService instead of productService for more accurate today's sales
            const salesTotal = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sales$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["salesService"].getTodaySales();
            setTodaySales(salesTotal);
        } catch (error) {
            console.error("Error loading today sales:", error);
            // Fallback to productService method if sales table doesn't exist yet
    ...
    const handleResetDailySales = async ()=>{
        if (confirm("Are you sure you want to reset today's sales? This cannot be undone.")) {
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sales$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["salesService"].resetDailySales();
                await loadProducts();
                await loadTodaySales();
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            ...
                            className: "bg-green-700 hover:bg-green-800 text-white px-3 py-1 rounded text-md transition-colors",
...
_s(Dashboard, "mJf4r2N5vNXeSsnoMWV5UrdZt4o=");
_c = Dashboard;
// Add Sell Icon
...
__turbopack_context__.k.register(_c1, "SellIcon");
...
//# sourceMappingURL=src_4f68cfb1._.js.map